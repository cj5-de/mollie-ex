defmodule MollieEx.Resources.PaymentRoutes.Create do
  ...
  alias MollieEx.Resources.PaymentRoutes.Options
  ...
  defp body(%Client{} = client, params, opts) do
    with :ok <- require_param(params, [:amount, "amount"], :missing_amount),
         :ok <- require_param(params, [:destination, "destination"], :missing_destination),
